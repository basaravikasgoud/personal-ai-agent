...
import { Bot, ArrowRight, Lock, Mail, User as UserIcon } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-400">Get started with automated task reasoning & tool execution</p>
          </div>
